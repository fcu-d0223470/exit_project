...
public class CustomPhotoGalleryActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_photo_galery);
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < len; i++) {
                    if (thumbnailsselection[i]) {
                        ...
                        photo_selected=new Photo(story_selected,arrPath[i]);

                        if(db.PhotoBelongsToAlbum(arrPath[i],story_selected)){//add to db
                            db.updatePhoto(photo_selected);
                        }else{
                            db.createPhoto(photo_selected);
                        }
                    }
                }
                if (cnt == 0) {
